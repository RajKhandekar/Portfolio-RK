<%
     //here we use jsp so not need to create session object it implicitly created here
    if(session.getAttribute("name")==null){
        response.sendRedirect("login.jsp");	
    }
%>
<!--  css file ss nhi liya smj jayega tumche dekho eclipse open krke hii -->
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top"> Develop With RK</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome to Raj Khandekar Portfolio</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - Full Stack</p>
		</div>
	</header>
	<!-- Portfolio Section-->
